...
function addCmsMarkers() {
  ...
  cmsItems.forEach(function(item) {
    ...
    listItem.innerHTML = `
      <h3>${title}</h3>
      <p>${address}</p>
      <a href="https://www.google.com/maps/dir/?api=1&destination=${lat},${lng}" target="_blank">Como chegar</a>
    `;
  ...
  var contentString = `
    <div class="info-window">
      <div class="info-window-content">
        <h3>${title}</h3>
        <p>${address}</p>
        <a href="https://www.google.com/maps/dir/?api=1&destination=${lat},${lng}" target="_blank">Como chegar <span>→</span></a>
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function(position) {
      ...
      marker = new google.maps.Marker({
        ...
        icon: {
          url: "https://cdn.prod.website-files.com/66cc84ae5ae8113288f88954/6717b1e42d2f3b7d9108f2c7_user-point.svg",
